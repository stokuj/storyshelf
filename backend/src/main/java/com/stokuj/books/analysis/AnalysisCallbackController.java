...
@RestController
@RequestMapping("/api/integration/analysis")
@Tag(name = "Integration (Analysis)", description = "Webhooks and triggers for asynchronous NLP analysis (Named Entity Recognition, statistics, relations) handled by an external analysis worker.")
public class AnalysisCallbackController {
    ...
    public AnalysisCallbackController(BookChapterRepository chapterRepository,
    ...
    @Operation(summary = "Receive chapter statistics results", description = "Webhook used by analysis worker to save text analysis results (e.g. word count, characters, tokens).")
    ...
    @Operation(summary = "Receive NER (Named Entity Recognition) results", description = "Webhook used by analysis worker to process and save recognized entities (mainly characters) in a chapter.")
    ...
    @Operation(summary = "Receive character pairs for relation analysis", description = "Webhook used by analysis worker to receive initially identified character pairs in a book.")
    @ApiResponse(responseCode = "200", description = "StoryCharacter pairs saved successfully")
    ...
    @Operation(summary = "Receive character relations results", description = "Webhook used by analysis worker to save sentiment/type of relations between characters.")
    @ApiResponse(responseCode = "200", description = "StoryCharacter relations saved successfully")
    @ApiResponse(responseCode = "404", description = "Book not found")
