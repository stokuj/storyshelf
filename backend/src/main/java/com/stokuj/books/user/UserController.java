...
import com.stokuj.books.user.UserProfileResponse;
import com.stokuj.books.user.UserProfileUpdateRequest;
import com.stokuj.books.user.UserSettingsResponse;
