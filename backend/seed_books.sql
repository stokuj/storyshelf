...
--  BOOKS
-- -----------------------------------------------------------
INSERT INTO books (title, author, year, isbn, description, page_count, rating, ratings_count, created_at, updated_at)
VALUES
-- 1
('Wiedźmin: Ostatnie życzenie',
 ...
 288, 4.6, 312400, CURRENT_DATE, CURRENT_DATE),
-- 2
('Dune',
 'Frank Herbert',
 1965,
 ...
 412, 4.7, 891200, CURRENT_DATE, CURRENT_DATE),
-- 3
('1984',
 'George Orwell',
 1949,
 ...
 328, 4.7, 3200000, CURRENT_DATE, CURRENT_DATE),
-- 4
('Zbrodnia i kara',
 'Fiodor Dostojewski',
 1866,
 ...
 551, 4.5, 624000, CURRENT_DATE, CURRENT_DATE),
-- 5
('Mistrz i Małgorzata',
 'Michaił Bułhakow',
 1967,
 ...
 480, 4.8, 445000, CURRENT_DATE, CURRENT_DATE),
-- 6
('Nowy wspaniały świat',
 ...
 311, 4.2, 1180000, CURRENT_DATE, CURRENT_DATE),
-- 7
('Hobbit',
 'J.R.R. Tolkien',
 1937,
 ...
 310, 4.7, 2100000, CURRENT_DATE, CURRENT_DATE),
-- 8
('Solaris',
 'Stanisław Lem',
 1961,
 ...
 272, 4.5, 198000, CURRENT_DATE, CURRENT_DATE),
-- 9
('Fahrenheit 451',
 'Ray Bradbury',
 1953,
 ...
 249, 4.4, 1560000, CURRENT_DATE, CURRENT_DATE),
-- 10
('Władca Pierścieni: Drużyna Pierścienia',
 ...
 423, 4.9, 4200000, CURRENT_DATE, CURRENT_DATE),
-- 11
('Sto lat samotności',
 ...
 417, 4.6, 870000, CURRENT_DATE, CURRENT_DATE),
-- 12
('Mały Książę',
 ...
 96, 4.5, 2800000, CURRENT_DATE, CURRENT_DATE),
-- 13
('Harry Potter i Kamień Filozoficzny',
 ...
 309, 4.8, 8900000, CURRENT_DATE, CURRENT_DATE),
-- 14
('Proces',
 'Franz Kafka',
 1925,
 ...
 255, 4.3, 389000, CURRENT_DATE, CURRENT_DATE),
-- 15
('Buszujący w zbożu',
 'J.D. Salinger',
 1951,
 ...
 277, 4.0, 1450000, CURRENT_DATE, CURRENT_DATE),
-- 16
('Diuna: Mesjasz',
 'Frank Herbert',
 1969,
 ...
 331, 4.4, 412000, CURRENT_DATE, CURRENT_DATE),
-- 17
('Noc żywych truposzy — Wywiad z wampirem',
 ...
 340, 4.1, 567000, CURRENT_DATE, CURRENT_DATE),
-- 18
('Opowieść podręcznej',
 'Margaret Atwood',
 1985,
 ...
 311, 4.5, 2100000, CURRENT_DATE, CURRENT_DATE),
-- 19
('Ciemne materie: Złoty Kompas',
 ...
 351, 4.6, 1230000, CURRENT_DATE, CURRENT_DATE),
-- 20
('Cyberiada',
 'Stanisław Lem',
 1965,
 ...
 295, 4.6, 87000, CURRENT_DATE, CURRENT_DATE);
